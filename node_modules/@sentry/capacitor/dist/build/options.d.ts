 ...
 */
export interface CapacitorOptions extends Omit<BrowserOptions, '_experiments' | 'enableMetrics' | 'sendDefaultPii' | 'replaysOnErrorSampleRate' | 'replaysSessionSampleRate' | 'profilesSampleRate' | 'profileLifecycle' | 'profileSessionSampleRate'>, BaseCapacitorOptions {
}
/**
...
export interface CapacitorClientOptions extends Omit<ClientOptions<CapacitorTransportOptions>, '_experiments' | 'enableMetrics' | 'sendDefaultPii' | 'replaysOnErrorSampleRate' | 'replaysSessionSampleRate' | 'profilesSampleRate' | 'profileLifecycle' | 'profileSessionSampleRate'>, BaseCapacitorOptions {
}
export {};
