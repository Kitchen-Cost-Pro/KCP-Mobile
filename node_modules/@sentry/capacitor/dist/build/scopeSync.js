...
exports.disableSyncToNative = disableSyncToNative;
...
function disableSyncToNative(scope) {
    ...
    (0, fill_1.restorefillTyped)(scope, 'clearBreadcrumbs');
    (0, fill_1.restorefillTyped)(scope, 'setContext');
    (0, fill_1.restorefillTyped)(scope, 'setExtra');
    (0, fill_1.restorefillTyped)(scope, 'setExtras');
    (0, fill_1.restorefillTyped)(scope, 'setTags');
    (0, fill_1.restorefillTyped)(scope, 'setTag');
    (0, fill_1.restorefillTyped)(scope, 'setUser');
    (0, fill_1.restorefillTyped)(scope, 'addBreadcrumb');
}
