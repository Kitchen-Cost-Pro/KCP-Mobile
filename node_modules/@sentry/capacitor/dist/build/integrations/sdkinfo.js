...
exports.sdkInfoIntegration = exports.defaultSdkInfo = void 0;
const core_1 = require("@sentry/core");
const version_1 = require("../version");
const wrapper_1 = require("../wrapper");
exports.defaultSdkInfo = {
...
async function processEvent(event) {
    ...
    if (wrapper_1.NATIVE.platform === 'ios' && NativeSdkPackage === null) {
        try {
            ...
            core_1.debug.warn('[SdkInfo] Native SDK Info retrieval failed...something could be wrong with your Sentry installation.');
        }
    }
