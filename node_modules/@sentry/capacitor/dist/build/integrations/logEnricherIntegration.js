...
exports.logEnricherIntegration = void 0;
const core_1 = require("@sentry/core");
const wrapper_1 = require("../wrapper");
const INTEGRATION_NAME = 'LogEnricher';
const logEnricherIntegration = () => {
    return {
        ...
        setup(client) {
            ...
            cacheLogContext().then(() => {
                ...
                core_1.debug.log(reason);
            });
        },
    };
};
exports.logEnricherIntegration = logEnricherIntegration;
...
async function cacheLogContext() {
    var _a, _b, _c, _d, _e;
    try {
        const response = await wrapper_1.NATIVE.fetchNativeLogAttributes();
        NativeCache = {
