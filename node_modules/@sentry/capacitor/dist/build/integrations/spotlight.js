...
function spotlightIntegration(spotlightOptions) {
    ...
    if (spotlightOptions === null || spotlightOptions === void 0 ? void 0 : spotlightOptions.sidecarUrl) {
        webViewUrl_1.CAP_GLOBAL_OBJ.CAP_SPOTLIGHT_URL = spotlightOptions.sidecarUrl;
    }
    if (wrapper_1.NATIVE.platform === 'web') {
        return (0, browser_1.spotlightBrowserIntegration)(spotlightOptions);
    }
    return {
        name: 'Spotlight',
    };
