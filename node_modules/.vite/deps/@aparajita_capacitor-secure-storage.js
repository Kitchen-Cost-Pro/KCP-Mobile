...
var proxy = registerPlugin("SecureStorage", {
	web: async () => {
		return new (await (import("./web-6N1V54ey.js"))).SecureStorageWeb();
	},
	ios: async () => {
		return new (await (import("./native-S8IBt-Gn.js"))).SecureStorageNative(proxy);
	},
	android: async () => {
		return new (await (import("./native-S8IBt-Gn.js"))).SecureStorageNative(proxy);
	}
...
//#endregion
export { KeychainAccess, proxy as SecureStorage, StorageError, StorageErrorType };
