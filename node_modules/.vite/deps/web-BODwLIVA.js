...
import { i as CapacitorBarcodeScannerTypeHint, o as Html5Qrcode, r as CapacitorBarcodeScannerScanOrientation } from "./definitions-BLn4bXPE.js";
//#region node_modules/@capacitor/barcode-scanner/dist/esm/web.js
/**
	...
	async scanBarcode(options) {
		...
		return new Promise((resolve, reject) => {
			...
			if (closeButton) closeButton.onclick = async () => {
				...
				reject(/* @__PURE__ */ new Error("Couldn’t scan because the process was cancelled."));
			};
			const scannerElement = document.getElementById("cap-os-barcode-scanner-container-scanner");
			if (!scannerElement) throw new Error("Scanner Element is required for web");
